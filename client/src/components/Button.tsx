  ...
  if (link && to) {
    return (
      <Link
        ...
        to={to}>
        <span className="flex gap-2 items-center rounded-full text-white hover:bg-opacity-20 hover:bg-hover px-4 py-2 text-sm font-medium transition  hover:ease-out">
          {children}
        </span>
      </Link>
    );
