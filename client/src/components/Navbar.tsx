...
const Navbar = () => {
  ...
  return (
    <nav className="fixed z-10 bg-bgColor bg-opacity-80 border-b border-hover backdrop-blur-lg drop-shadow-lg w-full flex justify-between items-center px-2 md:px-32 h-16">
