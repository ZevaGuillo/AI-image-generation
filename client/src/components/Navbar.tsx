...
const Navbar = () => {
  ...
  return (
    <nav className="fixed z-10 bg-bgColor bg-opacity-70 border-b border-hover backdrop-blur-lg drop-shadow-sm w-full flex justify-between items-center px-2 md:px-20 h-16">
